...
//Whether to use SMTP authentication
	...
	$sql3 = "Select * from application_data Where Email = '$mid'";
	...
	if($flag1 == 0 && $flag2 == 0)
	{
		$sql = "Update fdc_leave_data Set FDCM_name = '$_SESSION[name]', FDCM_mail = '$_SESSION[mail]', FDCM_Remark = '$remark', FDCM_Remark_Reason = '$remark_reason' Where Faculty_Mailid = '$mid'";
		...
		$sql = "Update fdc_sanction_data Set FDCM_name = '$_SESSION[name]', FDCM_mail = '$_SESSION[mail]', Remark = '$remark', Remark_Reason = '$remark_reason', Date_of_Meeting = '$date_of_meeting', Amount_Sanctioned = '$amount_sanctioned', ODs_sanctioned = '$ods_sanctioned' Where Faculty_Mail = '$mid'";
		$result = $conn->query($sql);
		if($result)
		{
